...
class EntranceZone(Room):
    ...
    def __init__(self):
        ...
        super().__init__([border_left, border_right_1, border_right_2, border_top_1, border_top_2, border_bottom, wall_1, wall_2], [entrance_door, exit_door], spawn_1, spawn_2, 0.5)
        pass
